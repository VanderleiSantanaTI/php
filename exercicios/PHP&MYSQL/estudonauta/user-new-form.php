    ...
    <table>
        ...
        <tr><td>Tipo<td><select name="tipo" id="tipo">
            <option value="admin">Administrador do Sistema</option>
                <option value="editor" selected>Editor Autorizador</option><!-- selected força ser a 1° opção-->
                </select>

        <tr><td>Senha<td><input type="password" name="senha1" id="senha1" size="10" maxlength="10">
        <tr><td>Confirmar a Senha<td><input type="password" name="senha2" id="senha2" size="10" maxlength="10">
